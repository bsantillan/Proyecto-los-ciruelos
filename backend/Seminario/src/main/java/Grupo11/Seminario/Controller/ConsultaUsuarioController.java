...
public class ConsultaUsuarioController {
    ...
    public List<Usuario> buscar_usuarios(
            @RequestParam Optional<String> nombre,
            @RequestParam Optional<String> apellido,
            @RequestParam Optional<String> email) {
        // Invocamos el servicio para buscar usuarios por los filtros
        return consultaUsuarioService.buscar_usuarios(nombre, apellido, email);
    }
}
